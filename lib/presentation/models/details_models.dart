...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    return UserModel(
      ...
      arabicPosition: json['arabic_position']?.toString(),
      grade: parseFlexibleInt(json['grade']),
      location: json['location']?.toString(),
      supervisorEmpId: json['supervisor_emp_id']?.toString(),
      supervisorEmpName: json['supervisor_emp_name']?.toString(),
      passportNumber: json['passport_number']?.toString(),
      personalEmail: json['personal_email']?.toString(),
      extensionNumber: parseFlexibleInt(json['extension_number']),
      faxNumber: json['fax_number']?.toString(),
      diplomaticName: json['diplomatic_name']?.toString(),
      avatar: json['avatar']?.toString(),
      fatherName: json['father_name']?.toString(),
      spouseName: json['spouse_name']?.toString(),
      children1Name: json['children1_name']?.toString(),
      children2Name: json['children2_name']?.toString(),
      address: json['address']?.toString(),
      religion: json['religion']?.toString(),
      currentBasicSalary: json['current_basic_salary']?.toString(),
      previousBasicSalary: json['previous_basic_salary']?.toString(),

      createdBy: parseFlexibleInt(json['created_by']),
      createdAt: json['created_at']?.toString(),
      updatedBy: parseFlexibleInt(json['updated_by']),
...
class ApproverUserModel {
  ...
  factory ApproverUserModel.fromJson(Map<String, dynamic> json) {
    return ApproverUserModel(
      ...
      department: json['department'] is Map
          ? parseFlexibleInt(json['department']['id'])
          : parseFlexibleInt(json['department']),
      category: json['category']?.toString(),
      directorate: json['directorate']?.toString(),

      section: json['section'] is Map
          ? parseFlexibleInt(json['section']['id'])
          : parseFlexibleInt(json['section']),
      position: json['position'] is Map
          ? parseFlexibleInt(json['position']['id'])
          : parseFlexibleInt(json['position']),
