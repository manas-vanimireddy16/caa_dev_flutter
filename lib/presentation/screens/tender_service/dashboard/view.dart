...
@RoutePage()
class TenderServiceDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const TenderServiceDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<TenderServiceDashboardScreen> createState() =>
      _TenderServiceDashboardScreenState();
}

class _TenderServiceDashboardScreenState
    extends ConsumerState<TenderServiceDashboardScreen> {
