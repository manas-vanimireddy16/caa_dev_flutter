...
@RoutePage()
class RequestTenderServiceDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestTenderServiceDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestTenderServiceDetailsScreenState();
}

class _RequestTenderServiceDetailsScreenState
    extends ConsumerState<RequestTenderServiceDetailsScreen> {
