...
@RoutePage()
class RequestTenderServiceScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestTenderServiceScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestTenderServiceScreen> createState() =>
      _RequestTenderServiceScreenState();
}

class _RequestTenderServiceScreenState
    extends ConsumerState<RequestTenderServiceScreen> {
