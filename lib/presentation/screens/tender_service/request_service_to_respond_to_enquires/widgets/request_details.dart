...
@RoutePage()
class RequestAServiceToRespondToEnquiriesDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  @override
  ConsumerState createState() => _RequestAServiceToRespondToEnquiriesDetailsScreenState();
}
