...
@RoutePage()
class RequestTenderAnalysisServiceScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestTenderAnalysisServiceScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestTenderAnalysisServiceScreen> createState() =>
      _RequestTenderAnalysisServiceScreenState();
}

class _RequestTenderAnalysisServiceScreenState
    extends ConsumerState<RequestTenderAnalysisServiceScreen> {
