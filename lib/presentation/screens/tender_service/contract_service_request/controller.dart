...
class _VSController extends StateNotifier<_ViewState> {
  ...
  List<DynamicField> buildContractServiceFields(DashboardL10n l10n) => [
    ...
    DynamicField(
      ...
      placeholder: l10n.enterProjectCodeBudgetCode,
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    try {
      ...
      await contractServiceInstance.deleteAttachment(
        attachmentId,
  ...
  Future<List<ContractServiceModel>> loadMyRequestsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await contractServiceInstance.getRequests(
  ...
  Future<List<ContractServiceModel>> loadActionItemsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await contractServiceInstance.getActionItems(
        offset: ListPagination.offsetForPage(pageKey),
        limit: ListPagination.pageSize,
        searchText: searchText,
        status: status,
