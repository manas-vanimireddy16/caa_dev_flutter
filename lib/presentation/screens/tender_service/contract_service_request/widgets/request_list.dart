...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, ContractServiceModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, ContractServiceModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<ContractServiceModel>(
