...
@RoutePage()
class ContractServiceRequestNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const ContractServiceRequestNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<ContractServiceRequestNewRequestScreen> createState() =>
      _ContractServiceRequestNewRequestScreenState();
}

class _ContractServiceRequestNewRequestScreenState
    extends ConsumerState<ContractServiceRequestNewRequestScreen> {
