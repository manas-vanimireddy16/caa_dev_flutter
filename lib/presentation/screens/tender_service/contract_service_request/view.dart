...
@RoutePage()
class ContractServiceRequestScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const ContractServiceRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<ContractServiceRequestScreen> createState() =>
      _ContractServiceRequestScreenState();
}

class _ContractServiceRequestScreenState
    extends ConsumerState<ContractServiceRequestScreen> {
