...
@RoutePage()
class AssignaTasktoEmployeeDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const AssignaTasktoEmployeeDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _AssignaTasktoEmployeeDetailsScreenState();
}

class _AssignaTasktoEmployeeDetailsScreenState
    extends ConsumerState<AssignaTasktoEmployeeDetailsScreen> {
              ...
              children: [
                ...
                if (selectedTab == 0)
                  ...
                  CommentsCard(
                    ...
                    onInProgress: () async {
                      controller.onSendInProgress(
                        approverId ?? 0,
                        requestId ?? 0,
                      );
                    },
                    onComplete: () async {
                      controller.onComplete(approverId ?? 0, requestId ?? 0);
                    },
                  )
