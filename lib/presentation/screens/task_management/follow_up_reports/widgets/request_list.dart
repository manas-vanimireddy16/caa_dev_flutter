...
class _RequestsPageState extends ConsumerState<RequestsPage>
  ...
  PagingController<int, FollowUpReportRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, FollowUpReportRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<FollowUpReportRequestModel>(
