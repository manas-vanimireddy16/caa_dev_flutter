...
@RoutePage()
class FollowUpReportScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const FollowUpReportScreen({
    super.key,
  ...
  @override
  ConsumerState<FollowUpReportScreen> createState() =>
      _FollowUpReportScreenState();
}

class _FollowUpReportScreenState extends ConsumerState<FollowUpReportScreen> {
