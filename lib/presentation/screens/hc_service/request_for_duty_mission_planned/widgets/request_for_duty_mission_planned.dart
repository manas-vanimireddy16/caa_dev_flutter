...
@RoutePage()
class RequestforDutyMissionPlannedRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const RequestforDutyMissionPlannedRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestforDutyMissionPlannedRequestScreen> createState() =>
      _RequestforDutyMissionPlannedRequestScreenState();
}

class _RequestforDutyMissionPlannedRequestScreenState
    extends ConsumerState<RequestforDutyMissionPlannedRequestScreen> {
