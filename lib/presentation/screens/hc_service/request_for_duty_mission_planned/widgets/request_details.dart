...
@RoutePage()
class RequestforDutyMissionPlannedDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestforDutyMissionPlannedDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _RequestforDutyMissionPlannedDetailsScreenState();
}

class _RequestforDutyMissionPlannedDetailsScreenState
    extends ConsumerState<RequestforDutyMissionPlannedDetailsScreen> {
