...
import 'package:code_setup/presentation/screens/hc_service/request_for_duty_mission_planned/widgets/allowance_request_form.dart';
...
part 'widgets/request_for_duty_mission_planned.dart';
...
part 'widgets/allowance_form.dart';
part 'widgets/travel_details_form.dart';

@RoutePage()
class RequestforDutyMissionPlannedScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const RequestforDutyMissionPlannedScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestforDutyMissionPlannedScreen> createState() =>
      _RequestforDutyMissionPlannedScreenState();
}

class _RequestforDutyMissionPlannedScreenState
    extends ConsumerState<RequestforDutyMissionPlannedScreen>
