...
@RoutePage()
class AnnualIncrementNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const AnnualIncrementNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<AnnualIncrementNewRequestScreen> createState() =>
      _AnnualIncrementNewRequestScreenState();
}

class _AnnualIncrementNewRequestScreenState
    extends ConsumerState<AnnualIncrementNewRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.annualIncrementForm],

          onSubmit: (values) async {
            await controller.submitAnnualIncrementRequest(
              widget.serviceId,
              widget.subServiceId,
              values,
            );
