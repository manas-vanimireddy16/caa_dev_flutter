...
@RoutePage()
class AnnualIncrementDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const AnnualIncrementDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _AnnualIncrementDetailsScreenState();
}

class _AnnualIncrementDetailsScreenState
    extends ConsumerState<AnnualIncrementDetailsScreen> {
