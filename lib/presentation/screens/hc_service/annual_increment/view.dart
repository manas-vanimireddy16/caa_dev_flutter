...
part 'widgets/annual_increment_new_request.dart';
...
@RoutePage()
class AnnualIncrementScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const AnnualIncrementScreen({
    super.key,
  ...
  @override
  ConsumerState<AnnualIncrementScreen> createState() =>
      _AnnualIncrementScreenState();
}

class _AnnualIncrementScreenState extends ConsumerState<AnnualIncrementScreen> {
