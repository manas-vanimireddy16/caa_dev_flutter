...
@RoutePage()
class PromotionsDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  @override
  ConsumerState createState() => _PromotionsDetailsScreenState();
}

class _PromotionsDetailsScreenState
    extends ConsumerState<PromotionsDetailsScreen> {
