...
@RoutePage()
class RequestforDutyMissionDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestforDutyMissionDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestforDutyMissionDetailsScreenState();
}

class _RequestforDutyMissionDetailsScreenState
    extends ConsumerState<RequestforDutyMissionDetailsScreen> {
