...
@RoutePage()
class HCServicesDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const HCServicesDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<HCServicesDashboardScreen> createState() =>
      _HCServicesDashboardScreenState();
}

class _HCServicesDashboardScreenState
    extends ConsumerState<HCServicesDashboardScreen> {
