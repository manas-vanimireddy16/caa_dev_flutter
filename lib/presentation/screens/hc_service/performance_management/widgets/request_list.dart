...
class _RequestsPageState extends ConsumerState<RequestsPage>
  ...
  PagingController<int, PerformanceManagementModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, PerformanceManagementModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<PerformanceManagementModel>(
