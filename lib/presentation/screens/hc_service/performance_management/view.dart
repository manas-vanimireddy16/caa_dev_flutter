...
import 'package:code_setup/presentation/screens/hc_service/performance_management/widgets/dynamic_weight_list.dart';
...
class PerformanceManagementScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PerformanceManagementScreen> createState() =>
      _PerformanceManagementScreenState();
}

class _PerformanceManagementScreenState
    extends ConsumerState<PerformanceManagementScreen> {
