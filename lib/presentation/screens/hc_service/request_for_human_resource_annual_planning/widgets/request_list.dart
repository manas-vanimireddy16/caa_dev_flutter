...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, HumanResourceAnnualPlanningModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController =
          PagingController<int, HumanResourceAnnualPlanningModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<HumanResourceAnnualPlanningModel>(
