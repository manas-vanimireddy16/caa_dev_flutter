...
@RoutePage()
class RequiredNewResourceDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequiredNewResourceDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequiredNewResourceDetailsScreenState();
}

class _RequiredNewResourceDetailsScreenState
    extends ConsumerState<RequiredNewResourceDetailsScreen> {
                  ...
                  CommonRequestDetails(
                    ...
                    requestInfo: {
                      ...
                      "Position to be Filled":
                          request?.positionToBeFilled ?? 'N/A',
                      "Grade": request?.grade ?? 'N/A',
                      "Role / Title of Resource": request?.roleTitle ?? 'N/A',
                      "Education Requirements":
                          request?.educationRequirements ?? 'N/A',
                      "Required Skills / Expertise":
                          request?.requiredSkills ?? 'N/A',
                      "Number of Years of Experience":
                          request?.yearsOfExperience ?? 'N/A',
