...
import 'package:code_setup/presentation/screens/hc_service/models/skills_enchancement_model.dart';
...
@RoutePage()
class SkillsEnhancementScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const SkillsEnhancementScreen({
    super.key,
  ...
  @override
  ConsumerState<SkillsEnhancementScreen> createState() =>
      _SkillsEnhancementScreenState();
}

class _SkillsEnhancementScreenState
    extends ConsumerState<SkillsEnhancementScreen> {
