...
@RoutePage()
class SkillsEnhancementDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const SkillsEnhancementDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _SkillsEnhancementDetailsScreenState();
}

class _SkillsEnhancementDetailsScreenState
    extends ConsumerState<SkillsEnhancementDetailsScreen> {
