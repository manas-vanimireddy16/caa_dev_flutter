...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, ImportExportMaterialModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, ImportExportMaterialModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<ImportExportMaterialModel>(
