...
@RoutePage()
class ImportExportMaterialPermissionNewRequestDetailsScreen
  ...
  const ImportExportMaterialPermissionNewRequestDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _ImportExportMaterialPermissionNewRequestDetailsScreenState();
}

class _ImportExportMaterialPermissionNewRequestDetailsScreenState
    extends
        ConsumerState<ImportExportMaterialPermissionNewRequestDetailsScreen> {
