...
part 'widgets/permission_new_request.dart';
...
@RoutePage()
class ImportExportMaterialPermissionScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const ImportExportMaterialPermissionScreen({
    super.key,
  ...
  @override
  ConsumerState<ImportExportMaterialPermissionScreen> createState() =>
      _ImportExportMaterialPermissionScreenState();
}

class _ImportExportMaterialPermissionScreenState
    extends ConsumerState<ImportExportMaterialPermissionScreen> {
