...
class _VSController extends StateNotifier<_ViewState> {
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    try {
      ...
      await bookcaahallsInstance.deleteAttachment(
        attachmentId,
  ...
  Future<List<BookCaaHallRequestModel>> loadMyRequestsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await bookcaahallsInstance.getRequests(
  ...
  Future<List<BookCaaHallRequestModel>> loadActionItemsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await bookcaahallsInstance.getActionItems(
        offset: ListPagination.offsetForPage(pageKey),
        limit: ListPagination.pageSize,
        searchText: searchText,
        status: status,
