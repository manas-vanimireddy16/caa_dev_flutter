...
@RoutePage()
class LegalServicesDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const LegalServicesDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<LegalServicesDashboardScreen> createState() =>
      _LegalServicesDashboardScreenState();
}

class _LegalServicesDashboardScreenState
    extends ConsumerState<LegalServicesDashboardScreen> {
  ...
  void initState() {
    ...
    final service =
        widget.service ??
        ref.read(serviceTreeProvider).serviceByCode('CAAS05') ??
        selected.service;
