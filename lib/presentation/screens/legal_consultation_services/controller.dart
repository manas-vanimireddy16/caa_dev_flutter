...
class _VSController extends StateNotifier<_ViewState> {
  ...
  String titleForIndex(int index) {
    switch (index) {
      case 0:
        return 'Request For Legal Contract Review';
      case 1:
        return 'Appeal Against Administrative Decisions';
      case 2:
        return 'Legal Consultation and Review of Administrative Decisions';
