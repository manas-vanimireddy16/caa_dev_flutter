...
@RoutePage()
class RequestForLegalContractReviewScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestForLegalContractReviewScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForLegalContractReviewScreen> createState() =>
      _RequestForLegalContractReviewScreenState();
}

class _RequestForLegalContractReviewScreenState
    extends ConsumerState<RequestForLegalContractReviewScreen> {
