...
@RoutePage()
class RequestForLegalContractReviewDetailsScreen
  ...
  const RequestForLegalContractReviewDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _RequestForLegalContractReviewDetailsScreenState();
}

class _RequestForLegalContractReviewDetailsScreenState
    extends ConsumerState<RequestForLegalContractReviewDetailsScreen> {
