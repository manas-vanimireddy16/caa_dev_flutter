...
@RoutePage()
class AppealAgainstAdministrativeDecisionsDetailsScreen
  ...
  const AppealAgainstAdministrativeDecisionsDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _AppealAgainstAdministrativeDecisionsDetailsScreenState();
}

class _AppealAgainstAdministrativeDecisionsDetailsScreenState
    extends ConsumerState<AppealAgainstAdministrativeDecisionsDetailsScreen> {
