...
class LegalConsultationandReviewofAdministrativeDecisionsScreen
  ...
  const LegalConsultationandReviewofAdministrativeDecisionsScreen({
    super.key,
  ...
  @override
  ConsumerState<LegalConsultationandReviewofAdministrativeDecisionsScreen>
  createState() =>
      _LegalConsultationandReviewofAdministrativeDecisionsScreenState();
}

class _LegalConsultationandReviewofAdministrativeDecisionsScreenState
    extends
        ConsumerState<
          LegalConsultationandReviewofAdministrativeDecisionsScreen
        > {
