...
@RoutePage()
class LegalConsultationandReviewofAdministrativeDecisionsDetailsScreen
  ...
  const LegalConsultationandReviewofAdministrativeDecisionsDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _LegalConsultationandReviewofAdministrativeDecisionsDetailsScreenState();
}

class _LegalConsultationandReviewofAdministrativeDecisionsDetailsScreenState
    extends
        ConsumerState<
          LegalConsultationandReviewofAdministrativeDecisionsDetailsScreen
        > {
