...
//     final serviceName = 'Legal Consultation Services';
//     final roles = KAppX.globalProvider.read(rolesProvider)?.services ?? [];
//     final List<Service> subServices = roles.firstWhere(
//       (r) => r.name == serviceName,
//       orElse: () => Service(),
//     );

//     // ToDO: search for service and sub service ids based on the service name and sub service name when clickon drawer menu item and then navigate to the screen with those ids as params
...
//         index: 1,
//         icon: KImageProvider(image: KIcons.dashboard),
//         label: 'Appeal Against Administrative Decisions',
//       ),
//       DrawerItemData(
//         index: 2,
//         icon: KImageProvider(image: KIcons.dashboard),
//         label: 'Legal Consultation and Review of Administrative Decisions',
//       ),
//     ];
...
class _DrawerMenu extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final serviceName = 'Legal Services';
