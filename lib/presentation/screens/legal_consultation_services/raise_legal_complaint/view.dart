...
class RaiseLegalComplaintScreen extends ConsumerStatefulWidget {
  ...
  const RaiseLegalComplaintScreen({
    super.key,
  ...
  @override
  ConsumerState<RaiseLegalComplaintScreen> createState() =>
      _RaiseLegalComplaintScreenState();
}

class _RaiseLegalComplaintScreenState
    extends ConsumerState<RaiseLegalComplaintScreen> {
