...
@RoutePage()
class SalalahNewRequestScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const SalalahNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<SalalahNewRequestScreen> createState() =>
      _SalalahNewRequestScreenState();
}

class _SalalahNewRequestScreenState
    extends ConsumerState<SalalahNewRequestScreen> {
