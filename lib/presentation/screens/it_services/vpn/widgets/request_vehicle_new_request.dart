...
@RoutePage()
class VpnNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const VpnNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<VpnNewRequestScreen> createState() =>
      _VpnNewRequestScreenState();
}

class _VpnNewRequestScreenState extends ConsumerState<VpnNewRequestScreen> {
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          onSubmit: (values) async {
            await controller.submitVpnRequest(
              widget.serviceId,
              widget.subServiceId,
              values,
            );
