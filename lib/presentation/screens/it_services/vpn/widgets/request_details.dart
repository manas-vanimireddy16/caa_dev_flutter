...
@RoutePage()
class VPNRequestDetailsTabScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  @override
  ConsumerState createState() => _VPNRequestDetailsTabScreenState();
}

class _VPNRequestDetailsTabScreenState
    extends ConsumerState<VPNRequestDetailsTabScreen> {
