...
class _RequestsPageState extends ConsumerState<RequestsPage>
  ...
  PagingController<int, AccessRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, AccessRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<AccessRequestModel>(
