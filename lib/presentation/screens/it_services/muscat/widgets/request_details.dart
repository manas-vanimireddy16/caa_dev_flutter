...
@RoutePage()
class MuscatRequestDetailsTabScreen extends ConsumerStatefulWidget {
  final int id;
  final Service service;
  final SubService subService;
  const MuscatRequestDetailsTabScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _MuscatRequestDetailsTabScreenState();
}

class _MuscatRequestDetailsTabScreenState
    extends ConsumerState<MuscatRequestDetailsTabScreen> {
