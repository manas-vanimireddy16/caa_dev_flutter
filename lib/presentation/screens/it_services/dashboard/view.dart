...
@RoutePage()
class ITServiceDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const ITServiceDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<ITServiceDashboardScreen> createState() =>
      _ITServiceDashboardScreenState();
}

class _ITServiceDashboardScreenState
    extends ConsumerState<ITServiceDashboardScreen> {
  ...
  void initState() {
    ...
    final service =
        widget.service ??
        ref.read(serviceTreeProvider).serviceByCode('CAAS01') ??
        selected.service;
