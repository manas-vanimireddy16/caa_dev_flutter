...
@RoutePage()
class RequestEventSupportDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestEventSupportDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestEventSupportDetailsScreenState();
}

class _RequestEventSupportDetailsScreenState
    extends ConsumerState<RequestEventSupportDetailsScreen> {
