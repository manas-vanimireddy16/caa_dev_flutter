...
class _RequestsPageState extends ConsumerState<RequestsPage>
  ...
  PagingController<int, EventSupportModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, EventSupportModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<EventSupportModel>(
