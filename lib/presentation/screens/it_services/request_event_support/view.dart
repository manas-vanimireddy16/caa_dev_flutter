...
@RoutePage()
class RequestEventSupportScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestEventSupportScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestEventSupportScreen> createState() =>
      _RequestEventSupportScreenState();
}

class _RequestEventSupportScreenState
    extends ConsumerState<RequestEventSupportScreen> {
