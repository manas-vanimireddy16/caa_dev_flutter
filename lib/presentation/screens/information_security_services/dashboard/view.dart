...
@RoutePage()
class InformationSecurityDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const InformationSecurityDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<InformationSecurityDashboardScreen> createState() =>
      _InformationSecurityDashboardScreenState();
}

class _InformationSecurityDashboardScreenState
    extends ConsumerState<InformationSecurityDashboardScreen> {
