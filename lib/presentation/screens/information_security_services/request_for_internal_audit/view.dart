...
@RoutePage()
class RequestForInternalAuditScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestForInternalAuditScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForInternalAuditScreen> createState() =>
      _RequestForInternalAuditScreenState();
}

class _RequestForInternalAuditScreenState
    extends ConsumerState<RequestForInternalAuditScreen> {
