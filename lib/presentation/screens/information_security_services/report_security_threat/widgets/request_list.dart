...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, SecurityThreatRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, SecurityThreatRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<SecurityThreatRequestModel>(
