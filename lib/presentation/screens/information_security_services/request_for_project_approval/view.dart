...
part 'widgets/request_for_project_approval_new_request_new_request.dart';
...
@RoutePage()
class RequestForProjectApprovalScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestForProjectApprovalScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForProjectApprovalScreen> createState() =>
      _RequestForProjectApprovalScreenState();
}

class _RequestForProjectApprovalScreenState
    extends ConsumerState<RequestForProjectApprovalScreen> {
