...
@RoutePage()
class RequestForProjectApprovalDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestForProjectApprovalDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestForProjectApprovalDetailsScreenState();
}

class _RequestForProjectApprovalDetailsScreenState
    extends ConsumerState<RequestForProjectApprovalDetailsScreen> {
