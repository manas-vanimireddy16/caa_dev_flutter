...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, CyberSecurityRiskRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, CyberSecurityRiskRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<CyberSecurityRiskRequestModel>(
