...
@RoutePage()
class CyberSecurityRiskManagementDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const CyberSecurityRiskManagementDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _CyberSecurityRiskManagementDetailsScreenState();
}

class _CyberSecurityRiskManagementDetailsScreenState
    extends ConsumerState<CyberSecurityRiskManagementDetailsScreen> {
