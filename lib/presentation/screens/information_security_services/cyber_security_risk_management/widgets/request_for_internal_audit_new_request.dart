...
@RoutePage()
class CyberSecurityRiskManagementNewRequestScreen
  ...
  const CyberSecurityRiskManagementNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<CyberSecurityRiskManagementNewRequestScreen> createState() =>
      _CyberSecurityRiskManagementNewRequestScreenState();
}

class _CyberSecurityRiskManagementNewRequestScreenState
    extends ConsumerState<CyberSecurityRiskManagementNewRequestScreen> {
