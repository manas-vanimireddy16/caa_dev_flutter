...
@RoutePage()
class ResidentalUnitRentalScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const ResidentalUnitRentalScreen({
    super.key,
  ...
  @override
  ConsumerState<ResidentalUnitRentalScreen> createState() =>
      _ResidentalUnitRentalScreenState();
}

class _ResidentalUnitRentalScreenState
    extends ConsumerState<ResidentalUnitRentalScreen> {
