...
part 'widgets/renewal_housing_contract_new_request.dart';
...
@RoutePage()
class RequestToRenewalHousingContractScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestToRenewalHousingContractScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestToRenewalHousingContractScreen> createState() =>
      _RequestToRenewalHousingContractScreenState();
}

class _RequestToRenewalHousingContractScreenState
    extends ConsumerState<RequestToRenewalHousingContractScreen> {
