...
part 'widgets/cancel_housing_contract_new_request.dart';
...
@RoutePage()
class CancelHousingContractScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const CancelHousingContractScreen({
    super.key,
  ...
  @override
  ConsumerState<CancelHousingContractScreen> createState() =>
      _CancelHousingContractScreenState();
}

class _CancelHousingContractScreenState
    extends ConsumerState<CancelHousingContractScreen> {
