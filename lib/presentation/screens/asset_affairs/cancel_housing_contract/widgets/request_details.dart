...
@RoutePage()
class CancelHousingContractDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const CancelHousingContractDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _CancelHousingContractDetailsScreenState();
}

class _CancelHousingContractDetailsScreenState
    extends ConsumerState<CancelHousingContractDetailsScreen> {
