...
@RoutePage()
class CancelHousingContractNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const CancelHousingContractNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<CancelHousingContractNewRequestScreen> createState() =>
      _CancelHousingContractNewRequestScreenState();
}

class _CancelHousingContractNewRequestScreenState
    extends ConsumerState<CancelHousingContractNewRequestScreen> {
