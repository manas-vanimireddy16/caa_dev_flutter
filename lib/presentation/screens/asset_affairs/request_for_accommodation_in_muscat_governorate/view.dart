...
@RoutePage()
class RequestForAccommodationInMuscatGovernorateScreen
    extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestForAccommodationInMuscatGovernorateScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForAccommodationInMuscatGovernorateScreen>
  createState() => _RequestForAccommodationInMuscatGovernorateScreenState();
}

class _RequestForAccommodationInMuscatGovernorateScreenState
    extends ConsumerState<RequestForAccommodationInMuscatGovernorateScreen> {
