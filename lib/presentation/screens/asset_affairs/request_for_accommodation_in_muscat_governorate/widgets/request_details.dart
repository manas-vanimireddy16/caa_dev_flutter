...
@RoutePage()
class RequestForAccommodationInMuscatGovernorateDetailsScreen
  ...
  const RequestForAccommodationInMuscatGovernorateDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _RequestForAccommodationInMuscatGovernorateDetailsScreenState();
}

class _RequestForAccommodationInMuscatGovernorateDetailsScreenState
    extends
        ConsumerState<RequestForAccommodationInMuscatGovernorateDetailsScreen> {
