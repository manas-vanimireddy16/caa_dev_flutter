...
@RoutePage()
class RequestForAccommodationInMuscatGovernorateNewRequestScreen
  ...
  const RequestForAccommodationInMuscatGovernorateNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForAccommodationInMuscatGovernorateNewRequestScreen>
  createState() =>
      _RequestForAccommodationInMuscatGovernorateNewRequestScreenState();
}

class _RequestForAccommodationInMuscatGovernorateNewRequestScreenState
    extends
        ConsumerState<
          RequestForAccommodationInMuscatGovernorateNewRequestScreen
        > {
