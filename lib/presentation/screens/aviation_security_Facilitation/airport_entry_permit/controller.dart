...
If you suspect privacy compromise: Close all tabs and windows you are browsing CAA's website with and inform us through by email info [at] CAA [dot]gov[dot]om.
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    try {
      ...
      await airportPermitInstance.deleteAttachment(
        attachmentId,
  ...
  Future<List<AirportPermitRequestModel>> loadMyRequestsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await airportPermitInstance.getRequests(
  ...
  Future<List<AirportPermitRequestModel>> loadActionItemsPage(
    int pageKey, {
    String searchText = '',
    String status = '',
  }) async {
    ...
    try {
      return await airportPermitInstance.getActionItems(
        offset: ListPagination.offsetForPage(pageKey),
        limit: ListPagination.pageSize,
        searchText: searchText,
        status: status,
