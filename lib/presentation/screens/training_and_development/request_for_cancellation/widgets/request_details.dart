...
@RoutePage()
class RequestForCancellationDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestForCancellationDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestForCancellationDetailsScreenState();
}

class _RequestForCancellationDetailsScreenState
    extends ConsumerState<RequestForCancellationDetailsScreen> {
