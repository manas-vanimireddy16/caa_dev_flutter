...
part 'widgets/request_for_cancellation_new_request.dart';
...
@RoutePage()
class RequestForCancellationScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestForCancellationScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForCancellationScreen> createState() =>
      _RequestForCancellationScreenState();
}

class _RequestForCancellationScreenState
    extends ConsumerState<RequestForCancellationScreen> {
