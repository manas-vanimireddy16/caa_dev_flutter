...
@RoutePage()
class AnnualTrainingPlanScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const AnnualTrainingPlanScreen({
    super.key,
  ...
  @override
  ConsumerState<AnnualTrainingPlanScreen> createState() =>
      _AnnualTrainingPlanScreenState();
}

class _AnnualTrainingPlanScreenState
    extends ConsumerState<AnnualTrainingPlanScreen>
