...
@RoutePage()
class AnnualTrainingPlanRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const AnnualTrainingPlanRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<AnnualTrainingPlanRequestScreen> createState() =>
      _AnnualTrainingPlanRequestScreenState();
}

class _AnnualTrainingPlanRequestScreenState
    extends ConsumerState<AnnualTrainingPlanRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.annualTrainingPlanForm],

          onSubmit: (values) async {
            await controller.submitAnnualPlanRequest(
              widget.serviceId,
              widget.subServiceId,
              values,
            );
