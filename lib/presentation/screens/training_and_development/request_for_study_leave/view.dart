...
@RoutePage()
class RequestForStudyLeaveScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const RequestForStudyLeaveScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestForStudyLeaveScreen> createState() =>
      _RequestForStudyLeaveScreenState();
}

class _RequestForStudyLeaveScreenState
    extends ConsumerState<RequestForStudyLeaveScreen>
