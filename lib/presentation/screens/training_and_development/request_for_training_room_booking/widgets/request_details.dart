...
@RoutePage()
class RequestforTrainingRoomBookingDetailsScreen
  ...
  const RequestforTrainingRoomBookingDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _RequestforTrainingRoomBookingDetailsScreenState();
}

class _RequestforTrainingRoomBookingDetailsScreenState
    extends ConsumerState<RequestforTrainingRoomBookingDetailsScreen> {
