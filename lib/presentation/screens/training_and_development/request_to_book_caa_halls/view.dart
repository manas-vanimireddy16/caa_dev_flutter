...
@RoutePage()
class RequestToBookCAAHallsScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;

  const RequestToBookCAAHallsScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestToBookCAAHallsScreen> createState() =>
      _RequestToBookCAAHallsScreenState();
}

class _RequestToBookCAAHallsScreenState
    extends ConsumerState<RequestToBookCAAHallsScreen> {
