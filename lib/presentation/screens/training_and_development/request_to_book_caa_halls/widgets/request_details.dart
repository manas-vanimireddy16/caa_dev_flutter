...
@RoutePage()
class RequestToBookCAAHallsDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestToBookCAAHallsDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestToBookCAAHallsDetailsScreenState();
}

class _RequestToBookCAAHallsDetailsScreenState
    extends ConsumerState<RequestToBookCAAHallsDetailsScreen> {
