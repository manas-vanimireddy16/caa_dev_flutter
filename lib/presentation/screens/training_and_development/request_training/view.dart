...
@RoutePage()
class RequestTrainingScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const RequestTrainingScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestTrainingScreen> createState() =>
      _RequestTrainingScreenState();
}

class _RequestTrainingScreenState extends ConsumerState<RequestTrainingScreen>
