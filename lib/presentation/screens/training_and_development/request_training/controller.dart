...
class _VSController extends StateNotifier<_ViewState> {
  ...
  Map<String, String> buildRequestCardData(
    ...
    return {
      ...
      'Place': item.place ?? '-',
      "Media Coverage Required": item.mediaCoverageRequired ?? '-',
  ...
  List<DynamicField> get trainingRequestForm => [
    /// -------- TYPE OF TRAINING --------
    DynamicField(
      name: 'typeOfTraining',
  ...
  Future<void> submitAnnualPlanRequest(
    ...
    try {
      ...
      final payload = {
        ...
        "type_of_training":
            values['typeOfTraining'], // Inside Training / Outside Training
        "type_of_category":
            values['typeOfCategory'], // Planned / Out of planned
        "description": values['description'],

        "start_date": values['startDate'], // yyyy-MM-dd
        "end_date": values['endDate'], // yyyy-MM-dd
        ...
        "media_coverage_required": values['mediaCoverageRequired'], // Yes / No
        // ================= ATTACHMENTS =================
        "attachments": attachments, // List<Map<String, dynamic>>
      };

      debugPrint("✅ Final Payload: $payload");

      // API CALL
      await requestTrainingInstance.sendRequestTrainingRequest(payload);
