...
class _RequestsPageState extends ConsumerState<RequestsPage>
  ...
  PagingController<int, RequestTrainingModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, RequestTrainingModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<RequestTrainingModel>(
