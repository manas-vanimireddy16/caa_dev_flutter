...
@RoutePage()
class RequestTrainingDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const RequestTrainingDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _RequestTrainingDetailsScreenState();
}

class _RequestTrainingDetailsScreenState
    extends ConsumerState<RequestTrainingDetailsScreen> {
