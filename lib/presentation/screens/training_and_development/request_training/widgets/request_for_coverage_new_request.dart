...
@RoutePage()
class RequestTrainingNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const RequestTrainingNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestTrainingNewRequestScreen> createState() =>
      _RequestTrainingNewRequestScreenState();
}

class _RequestTrainingNewRequestScreenState
    extends ConsumerState<RequestTrainingNewRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.trainingRequestForm],
