...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, HotelReservationRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, HotelReservationRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<HotelReservationRequestModel>(
