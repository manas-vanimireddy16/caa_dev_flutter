...
@RoutePage()
class HotelReservationDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const HotelReservationDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<HotelReservationDashboardScreen> createState() =>
      _HotelReservationDashboardScreenState();
}

class _HotelReservationDashboardScreenState
    extends ConsumerState<HotelReservationDashboardScreen> {
