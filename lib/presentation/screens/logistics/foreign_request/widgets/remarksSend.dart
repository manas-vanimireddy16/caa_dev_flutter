...
class RemarksSend extends ConsumerWidget {
  ...
  final List<ForeignApprovalDetail> approvals;
  final int id;
  ...
  bool _shouldShowApprovalButtons(
    dynamic rolesData,
    List<ForeignApprovalDetail> approvals,
  ) {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isChatNotEmpty = controller.foreignChatController.text
        .trim()
        .isNotEmpty;
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: KTextField(
                    controller: controller.foreignChatController,
                ...
                ElevatedButton.icon(
                  onPressed: isSendEnabled
                      ? () {
                          controller.sendChat(
                            id,
                            controller.foreignChatController.text.trim(),
                            isChatNotEmpty
                                ? 'text'
