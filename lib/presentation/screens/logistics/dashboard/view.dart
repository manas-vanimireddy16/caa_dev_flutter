...
@RoutePage()
class LogisticsServicesDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const LogisticsServicesDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<LogisticsServicesDashboardScreen> createState() =>
      _LogisticsServicesDashboardScreenState();
}

class _LogisticsServicesDashboardScreenState
    extends ConsumerState<LogisticsServicesDashboardScreen> {
  ...
  void initState() {
    ...
    final service =
        widget.service ??
        ref.read(serviceTreeProvider).serviceByCode('CAAS010') ??
        selected.service;
