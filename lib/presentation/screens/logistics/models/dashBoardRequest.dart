...
// RequestModel welcomeFromJson(String str) =>
//     RequestModel.fromJson(json.decode(str));

// String welcomeToJson(RequestModel data) => json.encode(data.toJson());
...
RequestModel dataModelFromJson(String str) =>
    RequestModel.fromJson(json.decode(str));

String dataModelToJson(RequestModel data) => json.encode(data.toJson());
...
class RequestModel {
  ...
  RequestModel({this.status, this.data, this.totalCount});
