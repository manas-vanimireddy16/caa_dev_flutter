...
// LogisticsRequestDetailModel welcomeFromJson(String str) =>
//     LogisticsRequestDetailModel.fromJson(json.decode(str));

// String welcomeToJson(LogisticsRequestDetailModel data) =>
//     json.encode(data.toJson());

// class LogisticsRequestDetailModel {
//   String? status;
//   LogisticsRequestDetailData? data;

//   LogisticsRequestDetailModel({this.status, this.data});

//   factory LogisticsRequestDetailModel.fromJson(Map<String, dynamic> json) =>
//       LogisticsRequestDetailModel(
//         status: json["status"],
//         data: json["data"] == null
//             ? null
//             : LogisticsRequestDetailData.fromJson(json["data"]),
//       );

//   Map<String, dynamic> toJson() => {"status": status, "data": data?.toJson()};
// }

// class LogisticsRequestDetailData {
//   Request? request;
...
//   factory LogisticsRequestDetailData.fromJson(
