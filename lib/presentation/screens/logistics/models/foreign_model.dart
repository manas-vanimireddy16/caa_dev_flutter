...
ForeignModel welcomeFromJson(String str) =>
    ForeignModel.fromJson(json.decode(str));

String welcomeToJson(ForeignModel data) => json.encode(data.toJson());

class ForeignModel {
  String? status;
  List<ForeignData>? data;
  int? totalCount;

  ForeignModel({this.status, this.data, this.totalCount});

  factory ForeignModel.fromJson(Map<String, dynamic> json) => ForeignModel(
    status: json["status"],
    data: json["data"] == null
        ? []
        : List<ForeignData>.from(
            json["data"]!.map((x) => ForeignData.fromJson(x)),
          ),
...
class ForeignData {
  ...
  List<ForeignAttachment>? attachments;
  ...
  factory ForeignData.fromJson(Map<String, dynamic> json) => ForeignData(
    ...
    attachments: json["attachments"] == null
        ? []
        : List<ForeignAttachment>.from(
            json["attachments"]!.map((x) => ForeignAttachment.fromJson(x)),
          ),
...
class ApprovalDetail {
  ...
  factory ApprovalDetail.fromJson(Map<String, dynamic> json) => ApprovalDetail(
    ...
    approverRole: json["approver_role"] == null
        ? null
        : Passenger.fromJson(json["approver_role"]),
...
class ForeignAttachment {
  ...
  factory ForeignAttachment.fromJson(Map<String, dynamic> json) =>
      ForeignAttachment(
        jsonIgnore: json["jsonIgnore"] == null
            ? []
            : List<JsonIgnore>.from(
...
class CreatedByUser {
  ...
  factory CreatedByUser.fromJson(Map<String, dynamic> json) => CreatedByUser(
    ...
    position: json["position"] == null
        ? null
        : Passenger.fromJson(json["position"]),
    arabicPosition: json["arabic_position"],
    grade: json["grade"],
    location: json["location"],
    supervisorEmpId: json["supervisor_emp_id"],
