...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, VehicleMaintenanceRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, VehicleMaintenanceRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<VehicleMaintenanceRequestModel>(
