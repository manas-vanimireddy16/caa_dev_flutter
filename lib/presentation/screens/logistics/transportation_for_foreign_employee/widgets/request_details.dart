...
@RoutePage()
class LogisticsForeignRequestDetailsTabScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  ConsumerState createState() =>
      _LogisticsForeignRequestDetailsTabScreenState();
}

class _LogisticsForeignRequestDetailsTabScreenState
    extends ConsumerState<LogisticsForeignRequestDetailsTabScreen> {
