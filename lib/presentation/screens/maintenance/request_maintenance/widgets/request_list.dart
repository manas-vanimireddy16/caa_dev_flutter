...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, MaintenanceRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, MaintenanceRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<MaintenanceRequestModel>(
