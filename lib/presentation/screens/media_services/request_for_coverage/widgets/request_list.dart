...
class _RequestsPageState extends ConsumerState<RequestsPage> {
  PagingController<int, MediaRequestModel>? _pagingController;
  ...
  void _ensureController(_VSController controller) {
    ...
    if (widget.isActionItemsTab) {
      _pagingController = PagingController<int, MediaRequestModel>(
  ...
  Widget build(BuildContext context) {
    ...
    return PaginatedListSection<MediaRequestModel>(
