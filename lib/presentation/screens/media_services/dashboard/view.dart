...
@RoutePage()
class MediaServiceDashboardScreen extends ConsumerStatefulWidget {
  final Service? service;
  final SubService? subService;
  final List<SubService> subServices;

  const MediaServiceDashboardScreen({
    super.key,
    this.service,
    this.subService,
  ...
  @override
  ConsumerState<MediaServiceDashboardScreen> createState() =>
      _MediaServiceDashboardScreenState();
}

class _MediaServiceDashboardScreenState
    extends ConsumerState<MediaServiceDashboardScreen> {
