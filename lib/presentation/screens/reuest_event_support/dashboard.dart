...
@RoutePage()
class RequestEventDashboardScreen extends ConsumerStatefulWidget {
  const RequestEventDashboardScreen({super.key});

  @override
  ConsumerState<RequestEventDashboardScreen> createState() =>
      _RequestEventDashboardState();
}

class _RequestEventDashboardState
    extends ConsumerState<RequestEventDashboardScreen>
