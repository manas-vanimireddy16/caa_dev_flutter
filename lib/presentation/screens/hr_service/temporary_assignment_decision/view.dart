...
part 'widgets/request_for_temporary_assignment_decision.dart';
...
@RoutePage()
class TemporaryAssignmentDecisionScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const TemporaryAssignmentDecisionScreen({
    super.key,
  ...
  @override
  ConsumerState<TemporaryAssignmentDecisionScreen> createState() =>
      _TemporaryAssignmentDecisionScreenState();
}

class _TemporaryAssignmentDecisionScreenState
    extends ConsumerState<TemporaryAssignmentDecisionScreen>
                      ...
                      children: [
                        ...
                        Consumer(
                          builder: (context, ref, _) {
                            final data =
                                state.temporaryAssignmentDecisionRequestData;
                            if (state.isLoading) {
                              return const Center(
