...
@RoutePage()
class TemporaryAssignmentDecisionDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const TemporaryAssignmentDecisionDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _TemporaryAssignmentDecisionDetailsScreenState();
}

class _TemporaryAssignmentDecisionDetailsScreenState
    extends ConsumerState<TemporaryAssignmentDecisionDetailsScreen> {
                ...
                if (selectedTab == 0)
                  CommonRequestDetails(
                    statusInfo: {
                      ...
                      "Assigned To": nextApprover?.approverRole?.name ?? 'N/A',
                    },
                    requestInfo: {
