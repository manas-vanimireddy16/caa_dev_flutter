...
@RoutePage()
class AssignmentDecisionDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const AssignmentDecisionDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _AssignmentDecisionDetailsScreenState();
}

class _AssignmentDecisionDetailsScreenState
    extends ConsumerState<AssignmentDecisionDetailsScreen> {
