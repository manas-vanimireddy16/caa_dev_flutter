                      ...
                      children: [
                        ...
                        Consumer(
                          builder: (context, ref, _) {
                            final data = state.assignmentDecisionRequestData;
                            if (state.isLoading) {
                              return const Center(
