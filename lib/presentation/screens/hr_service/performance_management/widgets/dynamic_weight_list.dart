import 'package:code_setup/presentation/screens/hr_service/performance_management/widgets/expandable_weight_card.dart';
...
class WeightList<T> extends StatefulWidget {
  ...
  @override
  State<WeightList<T>> createState() =>
      _DynamicWeightListState<T>();
}

class _DynamicWeightListState<T>
    extends State<WeightList<T>> {
