...
//                 ? state.kpiData.data
//                 : state.approvalKpiData.data, // for action items
//           ),
...
//                             final data = state.requiredNewResourceRequestData;
//                             if (state.isLoading) {
//                               return const Center(
...
//                         Consumer(
//                           builder: (context, ref, _) {
//                             final data = state.requiredNewResourceActionItems;
//                             if (state.isLoading) {
//                               return const Center(
//                                 child: CircularProgressIndicator(),
//                               );
...
//                   /// 🔥 Custom Riverpod Tabs
//                   _buildTabs(state, controller),
...
//                       children: [
//                         _buildMyRequests(state, controller),
//                         _buildActionItems(state, controller),
//                       ],
//                     ),
//                   ),
//                 ],
...
//   // ---------------------------
//   // Custom Tabs (No Controller)
//   // ---------------------------
//   Widget _buildTabs(_ViewState state, dynamic controller) {
//     return Row(
//       children: [
//         _tabItem(
//           title: "My Requests",
...
//   // Tab 0 Content
//   // ---------------------------
//   Widget _buildMyRequests(_ViewState state, dynamic controller) {
//     if (state.isLoading) {
//       return const Center(child: CircularProgressIndicator());
//     }

//     if (state.requiredNewResourceRequestData.isEmpty) {
//       return const Center(child: Text("No Data Found"));
//     }

//     return ListView.builder(
//       itemCount: state.requiredNewResourceRequestData.length,
//       itemBuilder: (context, index) {
//         final item = state.requiredNewResourceRequestData[index];

//         return RequestCard(
//           data: controller.buildRequestCardData(item),
//           onTap: () async {
//             await controller.openRequestDetails(item.base.id ?? 0);

//             // 🔥 Reset to My Requests when returning
...
//   // Tab 1 Content
//   // ---------------------------
//   Widget _buildActionItems(_ViewState state, dynamic controller) {
//     if (state.isLoading) {
//       return const Center(child: CircularProgressIndicator());
//     }

//     if (state.requiredNewResourceActionItems.isEmpty) {
//       return const Center(child: Text("No Data Found"));
//     }

//     return ListView.builder(
//       itemCount: state.requiredNewResourceActionItems.length,
//       itemBuilder: (context, index) {
//         final item = state.requiredNewResourceActionItems[index];
