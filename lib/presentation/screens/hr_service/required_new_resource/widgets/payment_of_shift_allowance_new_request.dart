...
@RoutePage()
class RequiredNewResourceNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const RequiredNewResourceNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<RequiredNewResourceNewRequestScreen> createState() =>
      _RequiredNewResourceNewRequestScreenState();
}

class _RequiredNewResourceNewRequestScreenState
    extends ConsumerState<RequiredNewResourceNewRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.requiredNewResourceForm],

          onSubmit: (values) async {
            await controller.submitRequiredNewResourceRequest(
              widget.serviceId,
              widget.subServiceId,
              values,
            );
