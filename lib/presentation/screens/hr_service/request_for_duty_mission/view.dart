...
@RoutePage()
class RequestforDutyMissionScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const RequestforDutyMissionScreen({
    super.key,
  ...
  @override
  ConsumerState<RequestforDutyMissionScreen> createState() =>
      _RequestforDutyMissionScreenState();
}

class _RequestforDutyMissionScreenState
    extends ConsumerState<RequestforDutyMissionScreen>
