...
@RoutePage()
class PaymentofCashAllowanceForLeaveDetailsScreen
  ...
  const PaymentofCashAllowanceForLeaveDetailsScreen({
    super.key,
    required this.id,
  ...
  ConsumerState createState() =>
      _PaymentofCashAllowanceForLeaveDetailsScreenState();
}

class _PaymentofCashAllowanceForLeaveDetailsScreenState
    extends ConsumerState<PaymentofCashAllowanceForLeaveDetailsScreen> {
                ...
                if (selectedTab == 0)
                  CommonRequestDetails(
                    ...
                    requestInfo: {
                      ...
                      "Shift Start Date": request.shiftStartDate.toString(),
                      "Shift End Date":
                          request.shiftEndDate.toString() ,
