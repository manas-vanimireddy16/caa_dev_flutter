...
@RoutePage()
class SkillsEnhancementNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const SkillsEnhancementNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<SkillsEnhancementNewRequestScreen> createState() =>
      _SkillsEnhancementNewRequestScreenState();
}

class _SkillsEnhancementNewRequestScreenState
    extends ConsumerState<SkillsEnhancementNewRequestScreen> {
