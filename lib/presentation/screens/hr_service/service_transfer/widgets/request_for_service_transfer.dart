...
@RoutePage()
class NewServiceTransferRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const NewServiceTransferRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<NewServiceTransferRequestScreen> createState() =>
      _NewServiceTransferRequestScreenState();
}

class _NewServiceTransferRequestScreenState
    extends ConsumerState<NewServiceTransferRequestScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    16.toVerticalSizedBox,
                    KDropdownField<String>(
                      fieldHeadingText: 'Request Type *',
                      value: state.selectedRequestType.isEmpty
                          ? null
                      ...
                      items: ['Internal', 'External']
                          .map(
                            (e) =>
                                KDropdownItem<String>(value: e, child: Text(e)),
                          )
                          .toList(),
                      onChanged: (value) {
                        if (value != null) {
                          controller.onselectedRequestTypeChange(value);
                        }
                      },
                    ),
                    16.toVerticalSizedBox,
                    ...
                    KTextField(
                      fieldHeadingText: "Current Entity *",
                      controller: controller.fromEntityController,
                      validator: (v) =>
                          v == null || v.isEmpty ? "Required" : null,
                    ),
                    KTextField(
                      fieldHeadingText: "Transferred to Entity *",
              ...
              KDropdownField<String>(
                fieldHeadingText: 'Salary Details *',
                value: state.selectedSalaryDetails.isEmpty
                    ? null
                    : state.selectedSalaryDetails,
                decoration: const InputDecoration(
                  labelText: "Select *",
                  border: OutlineInputBorder(),
                ),
                ...
                items:
                    [
                          'Retained with Same Financial Allocations and Grade',
                          'New Financial Allocations and Grade',
                        ]
                        .map(
                          (e) =>
                              KDropdownItem<String>(value: e, child: Text(e)),
                ...
                onChanged: (value) {
                  if (value != null) {
                    controller.onSelectedSalaryDetailsChange(value);
                  }
                },
              ),
