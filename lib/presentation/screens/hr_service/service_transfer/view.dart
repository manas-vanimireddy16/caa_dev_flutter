...
part 'widgets/request_for_service_transfer.dart';
...
@RoutePage()
class ServiceTransferScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const ServiceTransferScreen({
    super.key,
  ...
  @override
  ConsumerState<ServiceTransferScreen> createState() =>
      _ServiceTransferScreenState();
}

class _ServiceTransferScreenState extends ConsumerState<ServiceTransferScreen>
