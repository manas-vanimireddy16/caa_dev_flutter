...
@RoutePage()
class NewSecondmentDecisionRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const NewSecondmentDecisionRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<NewSecondmentDecisionRequestScreen> createState() =>
      _NewSecondmentDecisionRequestScreenState();
}

class _NewSecondmentDecisionRequestScreenState
    extends ConsumerState<NewSecondmentDecisionRequestScreen> {
