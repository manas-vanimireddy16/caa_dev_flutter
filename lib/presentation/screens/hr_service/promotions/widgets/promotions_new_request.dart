...
@RoutePage()
class PromotionsNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const PromotionsNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<PromotionsNewRequestScreen> createState() =>
      _PromotionsNewRequestScreenState();
}

class _PromotionsNewRequestScreenState
    extends ConsumerState<PromotionsNewRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.promotionForm],
