...
@RoutePage()
class PaymentofShiftAllowanceDetailsScreen extends ConsumerStatefulWidget {
  final String from;
  final int id;
  final int serviceId;
  ...
  const PaymentofShiftAllowanceDetailsScreen({
    super.key,
    required this.id,
  ...
  @override
  ConsumerState createState() => _PaymentofShiftAllowanceDetailsScreenState();
}

class _PaymentofShiftAllowanceDetailsScreenState
    extends ConsumerState<PaymentofShiftAllowanceDetailsScreen> {
