...
@RoutePage()
class PaymentofShiftAllowanceNewRequestScreen extends ConsumerStatefulWidget {
  final int serviceId;
  final int subServiceId;
  final Service service;
  final SubService subService;

  const PaymentofShiftAllowanceNewRequestScreen({
    super.key,
  ...
  @override
  ConsumerState<PaymentofShiftAllowanceNewRequestScreen> createState() =>
      _PaymentofShiftAllowanceNewRequestScreenState();
}

class _PaymentofShiftAllowanceNewRequestScreenState
    extends ConsumerState<PaymentofShiftAllowanceNewRequestScreen> {
    ...
    return KScaffold(
      ...
      body: ProviderScope(
        ...
        child: DynamicForm(
          ...
          stepTitles: const [''],
          steps: [controller.paymentofShiftAllowanceForm],
