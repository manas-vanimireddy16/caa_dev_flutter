...
@RoutePage()
class PaymentofShiftAllowanceScreen extends ConsumerStatefulWidget {
  final Service service;
  final SubService subService;
  const PaymentofShiftAllowanceScreen({
    super.key,
  ...
  @override
  ConsumerState<PaymentofShiftAllowanceScreen> createState() =>
      _PaymentofShiftAllowanceScreenState();
}

class _PaymentofShiftAllowanceScreenState
    extends ConsumerState<PaymentofShiftAllowanceScreen>
                      ...
                      children: [
                        ...
                        Consumer(
                          builder: (context, ref, _) {
                            final data =
                                state.requestForTrainingRoomBookingRequestData;
                            if (state.isLoading) {
                              return const Center(
