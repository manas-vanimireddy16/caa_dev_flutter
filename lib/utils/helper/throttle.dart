...
class KThrottle extends Stream<bool> implements Sink<Function> {
  Duration _duration;
  ...
  KThrottle([Duration duration = const Duration(seconds: 1)])
    : assert(!duration.isNegative),
      _duration = duration {
  ...
  @override
  dynamic add(Function data) => call(data);
