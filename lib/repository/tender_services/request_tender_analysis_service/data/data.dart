...
class RequestForTenderAnalysisServiceRepositoryImpl
    implements RequestForTenderAnalysisServiceRepository {
  @override
  ...
  @override
  Future<Map<String, dynamic>> requestForTenderAnalysisServiceCreateRequest(
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.requestTenderAnalysisDeleteAttachment(attachmentId);
