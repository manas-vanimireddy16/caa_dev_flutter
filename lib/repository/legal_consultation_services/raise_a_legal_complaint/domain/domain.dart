...
import 'package:code_setup/repository/legal_consultation_services/raise_a_legal_complaint/data/data.dart';

abstract class RaiseALegalComplaintRepository {
  factory RaiseALegalComplaintRepository() =>
      RaiseALegalComplaintRepositoryImple();
  ...
  Future<EmployeeList?> getUserById(int userId);
