...
import 'package:code_setup/repository/legal_consultation_services/request_for_legal_contract_review/domain/domain.dart';
...
class LegalContractReviewRepositoryImple
    implements LegalContractReviewRepository {
  @override
  ...
  @override
  Future<Map<String, dynamic>> sendLegalContractReviewNewRequest(
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.legalContractReviewDeleteAttachment(
      requestId,
      attachmentId,
    );
