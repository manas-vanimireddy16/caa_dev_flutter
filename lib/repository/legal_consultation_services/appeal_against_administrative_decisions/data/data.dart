...
class AppealAgainstAdministrativeDecisionsRepositoryImple
    implements AppealAgainstAdministrativeDecisionsRepository {
  @override
  ...
  sendAppealAgainstAdministrativeDecisionsNewRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.appealAgainstAdministrativeDecisionsSendRequest;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    const String url = ApiEndPoint.appealAgainstAdministrativeDecisionsKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    const String url =
        ApiEndPoint.appealAgainstAdministrativeDecisionsApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.appealAgainstAdministrativeDecisionsStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.appealAgainstAdministrativeDecisionsTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<AppealAgainstAdministrativeModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        const url = ApiEndPoint.appealAgainstAdministrativeDecisionsGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => AppealAgainstAdministrativeModel.fromJson(
  ...
  Future<List<AppealAgainstAdministrativeModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.appealAgainstAdministrativeDecisionsGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => AppealAgainstAdministrativeModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.appealAgainstAdministrativeDecisionsSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.appealAgainstAdministrativeDecisionsSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url =
        ApiEndPoint.appealAgainstAdministrativeDecisionsDeleteAttachment(
          requestId,
          attachmentId,
        );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    const String url = ApiEndPoint.appealAgainstAdministrativeDecisionsApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.appealAgainstAdministrativeDecisionsChatsById(
          id,
        );
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url =
            ApiEndPoint.appealAgainstAdministrativeDecisionsAttachmentsById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.appealAgainstAdministrativeDecisionsRequestById(
          id,
        );
        final response = await client.get(url);
