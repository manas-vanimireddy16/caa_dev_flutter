...
import 'package:code_setup/repository/information_security_services/request_for_internal_audit/data/data.dart';
import 'package:code_setup/repository/information_security_services/request_for_project_approval/data/data.dart';

abstract class RequestForInternalAuditRepository {
  factory RequestForInternalAuditRepository() =>
      RequestForInternalAuditRepositoryImple();
