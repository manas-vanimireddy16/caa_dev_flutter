...
import 'package:code_setup/repository/information_security_services/cyber_security_risk_management/data/data.dart';

abstract class CyberSecurityRiskManagementRepository {
  factory CyberSecurityRiskManagementRepository() =>
      CyberSecurityRiskManagementRepositoryImple();

  Future<List<EmployeeList>> getUsers(int departmentId);

  Future<Map<String, dynamic>> sendCyberSecurityRiskManagementNewRequest(
  ...
  Future<List<CyberSecurityRiskRequestModel>> getRequests({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
  ...
  Future<List<CyberSecurityRiskRequestModel>> getActionItems({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
