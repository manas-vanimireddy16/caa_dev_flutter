...
class RequestForTrainingRoomBookingRepositoryImple
  ...
  @override
  Future<void> sendRequestForTrainingRoomBookingRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForTrainingRoomBookingSendRequest;
    try {
      if (client != null) {
  ...
  Future<KPIResponse?> getKpiData(int service_id, int sub_service_id) async {
    String url = ApiEndPoint.requestForTrainingRoomBookingKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.requestForTrainingRoomBookingApprovalsKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForTrainingRoomBookingApprovalsStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForTrainingRoomBookingApprovalsTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.requestForTrainingRoomBookingStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForTrainingRoomBookingTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<TrainingandDevelopmentRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.requestForTrainingRoomBookingGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<TrainingandDevelopmentRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForTrainingRoomBookingGetActionItems,
          queryParameters: queryParams,
        );
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForTrainingRoomBookingSendChatById(
      id,
    );
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.requestForTrainingRoomBookingSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.requestForTrainingRoomBookingAttachmentsById(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForTrainingRoomBookingApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.requestForTrainingRoomBookingChatsById(id);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.requestForTrainingRoomBookingRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
