...
import 'package:code_setup/repository/it_services/request_event_support/data/data.dart';
...
import 'package:code_setup/repository/training_and_development/request_for_cancellation/data/data.dart';

abstract class RequestForCancellationRepository {
  factory RequestForCancellationRepository() => RequestForCancellationImpl();
