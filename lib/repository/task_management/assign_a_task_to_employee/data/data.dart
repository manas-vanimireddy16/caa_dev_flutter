...
class AssignaTasktoEmployeeDetailsRepositoryImple
    implements AssignaTasktoEmployeeDetailsRepository {
  @override
  ...
  @override
  Future<void> sendAssignaTasktoEmployeeRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.assignTaskToEmployeeNewRequest;
    try {
      if (client != null) {
  ...
  Future<KPIResponse?> getKpiData(int service_id, int sub_service_id) async {
    String url = ApiEndPoint.assignTaskKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.assignTaskApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData(
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.assignTaskApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData(
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.assignTaskApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData(String period) async {
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.assignTaskStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData(String period) async {
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.assignTaskTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  @override
  Future<List<TaskItem>> getRequests({
    required int offset,
    required int limit,
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.assignTaskRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  @override
  Future<List<TaskItem>> getActionItems({
    required int offset,
    required int limit,
    String status = '',
    String searchText = '',
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.assignTaskRequestsForApproval,
          queryParameters: queryParams,
        );
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.assignTaskSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.assignTaskSendAttachmentById(id);
  ...
  @override
  Future<void> onSendComplete(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.assignTaskComplete;
  ...
  @override
  Future<void> onSendInProgress(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.assignTaskSendInProgess(
      payload['request_id'],
    );
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.assignTaskChatById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.assignTaskRequestById(id);
        final response = await client.get(url);
