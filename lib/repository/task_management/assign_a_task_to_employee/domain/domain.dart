...
abstract class AssignaTasktoEmployeeDetailsRepository {
  factory AssignaTasktoEmployeeDetailsRepository() =>
      AssignaTasktoEmployeeDetailsRepositoryImple();

  Future<List<EmployeeList>> getUsers(int departmentId);

  Future<void> sendAssignaTasktoEmployeeRequest(Map<String, dynamic> payload);
