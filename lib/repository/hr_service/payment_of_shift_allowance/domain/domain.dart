...
import 'package:code_setup/repository/hr_service/payment_of_shift_allowance/data/data.dart';

abstract class PaymentofShiftAllowanceRepository {
  factory PaymentofShiftAllowanceRepository() =>
      PaymentofShiftAllowanceRepositoryImple();
