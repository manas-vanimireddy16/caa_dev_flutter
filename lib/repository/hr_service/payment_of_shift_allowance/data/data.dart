...
class PaymentofShiftAllowanceRepositoryImple
    implements PaymentofShiftAllowanceRepository {
  @override
  ...
  @override
  Future<Map<String, dynamic>> sendPaymentofShiftAllowanceRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentForShiftAllowanceSendRequest;
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.paymentForShiftAllowanceApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentForShiftAllowanceApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentForShiftAllowanceApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.paymentForShiftAllowanceStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentForShiftAllowanceTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<TemporaryDecision>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.paymentForShiftAllowanceGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<TemporaryDecision>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentForShiftAllowanceGetActionItems,
          queryParameters: queryParams,
        );
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentForShiftAllowanceSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentForShiftAllowanceSendAttachmentById(
      id,
    );
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.paymentForShiftAllowanceAttachmentById(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentForShiftAllowanceApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.paymentForShiftAllowanceChatsById(id);
        final response = await client.get(url);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.paymentForShiftAllowanceAttachmentById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.paymentForShiftAllowanceRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<EmployeeSummary>> getEmployeeList({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.paymentForShiftAllowanceAssignEmployees;
