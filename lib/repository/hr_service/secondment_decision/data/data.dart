...
class SecondmentDecisionRepositoryImple
  ...
  Future<void> sendAssignmentDecisionRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.secondmentDecisionNewRequest;
    try {
      if (client != null) {
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.secondmentDecisionApprovalKpiData;
    final client = await KAppX.network.secureClient();
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.secondmentDecisionApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.secondmentDecisionApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<TemporaryDecision>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.secondmentDecisionRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<TemporaryDecision>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.secondmentDecisionApprovalRequests,
          queryParameters: queryParams,
        );
  ...
  Future<RequestDetailData?> getRequestsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.secondmentDecisionRequestById(id);
        final response = await client.get(url);
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.secondmentDecisionSendChatById(id);
  ...
  Future<void> onReject(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.secondmentDecisionReject;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.secondmentDecisionChatById(id);
        final response = await client.get(url);
  ...
  Future<void> onAssignEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.secondmentDecisionEmployeeAssignEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
  ...
  Future<void> onReplaceEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.secondmentDecisionReplaceEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
