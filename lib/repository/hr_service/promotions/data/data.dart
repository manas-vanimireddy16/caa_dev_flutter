...
class PromotionsRepositoryImple implements PromotionsRepository {
  static const String _serviceLabel = 'Promotions';
  @override
  ...
  Future<Map<String, dynamic>> sendPromotionsRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.sendRequestForPromotion;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.promotionKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.promotionApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.promotionStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.promotionTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<PromotionsModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.promotionGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<PromotionsModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.promotionGetActionItems,
          queryParameters: queryParams,
        );
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.promotionSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.promotionSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.promotionSendAttachmentById(attachmentId);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.promotionApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.promotionChatsById(id);
        final response = await client.get(url);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.promotionAttachmentById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.promotionRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<void> onAssignEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.promotionAssign;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
