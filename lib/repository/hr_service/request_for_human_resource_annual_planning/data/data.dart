...
class HumanResourceAnnualPlanningRepositoryImple
    implements HumanResourceAnnualPlanningRepository {
  static const String _serviceLabel = 'Human Resource Annual Planning';
  @override
  ...
  @override
  Future<Map<String, dynamic>> sendHumanResourceAnnualPlanningRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.sendRequestForHumanResourceAnnualPlanning;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.humanResourceAnnualPlanningKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.humanResourceAnnualPlanningApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.humanResourceAnnualPlanningApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.humanResourceAnnualPlanningApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.humanResourceAnnualPlanningStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.humanResourceAnnualPlanningTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  @override
  Future<List<HumanResourceAnnualPlanningModel>> getRequests({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.humanResourceAnnualPlanningGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  @override
  Future<List<HumanResourceAnnualPlanningModel>> getActionItems({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.humanResourceAnnualPlanningGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => HumanResourceAnnualPlanningModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.humanResourceAnnualPlanningSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.humanResourceAnnualPlanningSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.humanResourceAnnualPlanningSendAttachmentById(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.humanResourceAnnualPlanningApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.humanResourceAnnualPlanningChatsById(id);
        final response = await client.get(url);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.humanResourceAnnualPlanningAttachmentById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.humanResourceAnnualPlanningRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
