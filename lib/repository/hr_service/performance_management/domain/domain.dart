...
import 'package:code_setup/presentation/screens/hc_service/models/performance_management_model.dart';
...
import 'package:code_setup/repository/hr_service/performance_management/data/data.dart';

abstract class PerformanceManagementRepository {
  factory PerformanceManagementRepository() =>
      PerformanceManagementRepositoryImple();

  Future<List<EmployeeList>> getUsers(int departmentId);

  Future<Map<String, dynamic>> sendPerformanceManagementRequest(
