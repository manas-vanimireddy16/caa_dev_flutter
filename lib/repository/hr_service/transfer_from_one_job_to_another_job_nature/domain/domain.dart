...
import 'package:code_setup/repository/hr_service/transfer_from_one_job_to_another_job_nature/data/data.dart';

abstract class TransferFromOneJobtoAnotherJobNatureRepository {
  factory TransferFromOneJobtoAnotherJobNatureRepository() =>
      TransferFromOneJobtoAnotherJobNatureRepositoryImple();
