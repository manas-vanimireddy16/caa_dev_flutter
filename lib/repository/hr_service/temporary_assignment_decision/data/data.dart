...
class TemporaryAssignmentDecisionRepoistryImple
  ...
  Future<List<TemporaryDecision>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.temporaryAssignmentDecisionRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<TemporaryDecision>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.temporaryAssignmentDecisionApprovalRequests,
          queryParameters: queryParams,
        );
  ...
  Future<RequestDetailData?> getRequestsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.temporaryAssignmentDecisionRequestById(id);
        final response = await client.get(url);
  ...
  Future<void> onAssignRejectClose(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.temporaryAssignmentDecisionApproval;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.temporaryAssignmentDecisionChatById(id);
        final response = await client.get(url);
  ...
  Future<void> onAssignEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.temporaryAssignmentDecisionEmployeeAssignEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
  ...
  Future<void> onReplaceEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.temporaryAssignmentDecisionReplaceEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
