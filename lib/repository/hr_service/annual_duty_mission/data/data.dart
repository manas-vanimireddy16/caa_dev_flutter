...
class AnnualDutyMissionRepoistryImple implements AnnualDutyMissionRepoistry {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData is Map &&
          ...
          employeeRawList =
              (responseData['data'] as List).first as List<dynamic>;
        }
        /// ---------------- CASE 2 ----------------
        /// {
        ///   "data": [ {...}, {...} ]
        ...
        /// ---------------- FALLBACK ----------------
        if (employeeRawList.isEmpty) {
          debugPrint('⚠️ getUsers: Employee list is EMPTY after parsing');
        }
  ...
  @override
  Future<void> sendAnnualDutyMissionRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.dutyMissionSendRequest;
    try {
      if (client != null) {
  ...
  Future<KPIResponse?> getKpiData(
    ...
    String url = ApiEndPoint.dutyMissionKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  // @override
  // Future<KPIResponse?> getCombinedKpiData(String tripType) async {
  //   String url = ApiEndPoint.airportEntryKpi;
  //   final client = await KAppX.network.secureClient();

  //   try {
  //     if (client != null) {
  //       final queryParams = {'trip_type': tripType};
  //       final response = await client.get(url, queryParameters: queryParams);
  ...
  // @override
  // Future<KPIResponse?> getCombinedApprovalKpiData(String tripType) async {
  ...
  Future<KPIResponse?> getApprovalKpiData(
    ...
    String url = ApiEndPoint.dutyMissionApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData(
    ...
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final queryParams = {'time_period': period, 'trip_type': tripType};
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.dutyMissionStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData(
    ...
    try {
      final client = await KAppX.network.secureClient();
      if (client != null) {
        final queryParams = {"year": period, "trip_type": tripType};

        /// Remove null values
        queryParams.removeWhere((key, value) => value == null);

        final response = await client.get(
          ApiEndPoint.dutyMissionTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData(
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.dutyMissionApprovalStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData(
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.dutyMissionApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<DutyMissionModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.dutyMissionGetRequest;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<DutyMissionModel>> getMissionIdDropDownValues({
    ...
    try {
      if (client != null) {
        final Map<String, dynamic> queryParams = {'trip_type': tripType};
  ...
  Future<List<DutyMissionModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.dutyMissionGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) =>
                    DutyMissionModel.fromJson(item as Map<String, dynamic>),
              )
              .toList();
  ...
  Future<RequestDetailData?> getRequestsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.dutyMissionRequestById(id);
        final response = await client.get(url);
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferSendChatById(id);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.dutyMissionApprove;
  ...
  Future<void> onReject(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferReject;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.dutyMissionChatById(id);
        final response = await client.get(url);
  ...
  Future<void> onAssignEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferAssignEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
  ...
  Future<void> onReplaceEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferReplaceEmployee;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
