...
class PaymentofCashAllowanceForLeaveRepositoryImple
  ...
  Future<Map<String, dynamic>> paymentofCashAllowanceForLeaveCreateRequest(
    ...
    final String url = ApiEndPoint.paymentofCashAllowanceForLeaveSendRequest;
  ...
  Future<KPIResponse?> getKpiData(int service_id, int sub_service_id) async {
    String url = ApiEndPoint.paymentofCashAllowanceForLeaveKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.paymentofCashAllowanceForLeaveApprovalKpiCards;
    final client = await KAppX.network.secureClient();
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentofCashAllowanceForLeaveApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentofCashAllowanceForLeaveApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.paymentofCashAllowanceForLeaveStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentofCashAllowanceForLeaveTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<PaymentOfCashAllowanceForLeaveRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.paymentofCashAllowanceForLeaveGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => PaymentOfCashAllowanceForLeaveRequestModel.fromJson(
          ...
          throw Exception(
            'Failed to fetch request for payment of shift allowance request: ${response.statusCode}',
          );
        }
      } else {
        return [];
      ...
      throw Exception(
        "Error fetching request for payment of shift allowance request: $e",
      );
    }
  }
  ...
  Future<List<PaymentOfCashAllowanceForLeaveRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.paymentofCashAllowanceForLeaveGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => PaymentOfCashAllowanceForLeaveRequestModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentofCashAllowanceForLeaveSendChatById(
      id,
    );
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.paymentofCashAllowanceForLeaveSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.paymentofCashAllowanceForLeaveSendAttachmentById(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentofCashAllowanceForLeaveApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.paymentofCashAllowanceForLeaveChatsById(id);
        final response = await client.get(url);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.paymentofCashAllowanceForLeaveAttachmentById(
          id,
        );
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.paymentofCashAllowanceForLeaveRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<void> onAssignEmployee(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.paymentofCashAllowanceForLeaveAssign;
    try {
      if (client != null) {
        final response = await client.put(url, data: payload);
