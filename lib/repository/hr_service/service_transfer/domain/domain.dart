...
abstract class ServiceTransferRepoistry {
  factory ServiceTransferRepoistry() => ServiceTransferRepoistryImple();
  Future<List<Position>> getPositions();
  Future<List<Employee>> getUsers();

  Future<void> sendServiceTransferDecisionRequest(Map<String, dynamic> payload);
