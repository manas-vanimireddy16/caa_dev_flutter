...
class ServiceTransferRepoistryImple implements ServiceTransferRepoistry {
  static const String _serviceLabel = 'Service Transfer';
  @override
  ...
  @override
  Future<void> sendServiceTransferDecisionRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferNewRequest;
    try {
      if (client != null) {
  ...
  Future<ServiceTransferTrend> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.serviceTransferTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<ServiceTransferTrend> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.serviceTransferApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<TemporaryDecision>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.serviceTransferRequests;
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<TemporaryDecision>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.serviceTransferApprovalRequests,
          queryParameters: queryParams,
        );
  ...
  Future<RequestDetailData?> getRequestsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.serviceTransferRequestById(id);
        final response = await client.get(url);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.serviceTransferApproval;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.serviceTransferChatById(id);
        final response = await client.get(url);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.serviceTransferSendAttachmentById(attachmentId);
