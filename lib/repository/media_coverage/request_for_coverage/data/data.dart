...
class RequestForCoverageRepositoryImple
    implements RequestForCoverageRepository {
  @override
  ...
  @override
  Future<void> sendRequestForCoverageRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForCoverageSendRequest;
    try {
      if (client != null) {
  ...
  Future<KPIResponse?> getKpiData(int service_id, int sub_service_id) async {
    String url = ApiEndPoint.requestForCoverageKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.requestForCoverageApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData(
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForCoverageApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<MediaRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.requestForCoverageGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          throw Exception(
            'Failed to fetch request for coverage request: ${response.statusCode}',
          );
        }
      } else {
        return [];
      ...
      throw Exception("Error fetching request for coverage request: $e");
    }
  }
  ...
  Future<List<MediaRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.requestForCoverageGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) =>
                    MediaRequestModel.fromJson(item as Map<String, dynamic>),
              )
              .toList();
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForCoverageSendChatById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.requestForCoverageAttachmentsById(attachmentId);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.requestForCoverageApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.requestForCoverageChatsById(id);
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.requestForCoverageRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
