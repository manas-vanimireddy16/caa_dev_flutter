...
class AirportEntryPermitRepositoryImpl implements AirportEntryPermitRepository {
  @override
  ...
  Future<Map<String, dynamic>> airportEntryCreateRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.airportEntrySendRequest;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.airportEntryKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.airportEntryApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.airportEntryStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.airportEntryTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<AirportPermitRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.airportEntryGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => AirportPermitRequestModel.fromJson(
  ...
  Future<List<AirportPermitRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.airportEntryGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => AirportPermitRequestModel.fromJson(
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.airportEntrySendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.airportEntryDeleteAttachment(attachmentId);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.airportEntryApprove;
  ...
  Future<List<ChatMessageModel>> getchatById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.airportEntryChatsById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<AttachmentModel>> getAttachmentsById({
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.airportEntryAttachmentsById(id);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.airportEntryRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  @override
  Future<List<NationalityData>> getNationalityList() async {
    final client = await KAppX.network.secureClient();

    try {
      if (client != null) {
        final url = ApiEndPoint.nationalityList;
        final response = await client.get(url);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map((e) => NationalityData.fromJson(e as Map<String, dynamic>))
              .toList();
        } else {
          throw Exception(
            'Failed to fetch Accommodation Muscat request: ${response.statusCode}',
