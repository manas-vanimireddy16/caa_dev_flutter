...
class AviationSecurityFacilitationRepoistoryImple
    implements AviationSecurityFacilitationRepoistory {
  @override
  Future<void> sendAirportEntryRequest(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.airportEntryPostRequest;
    try {
      if (client != null) {
