...
import 'package:code_setup/repository/maintenance/external_stations/domain/domain.dart';
...
class ExternalMaintenanceRepositoryImpl
    implements ExternalMaintenanceRepository {
  @override
  Future<Map<String, dynamic>> externalMaintenanceCreateRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.externalMaintenanceSendRequest;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.externalMaintenanceKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.externalMaintenanceApprovalKpiCards;
    final client = await KAppX.network.secureClient();
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.externalMaintenanceApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.externalMaintenanceApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.externalMaintenanceStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.externalMaintenanceTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<MaintenanceRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.externalMaintenanceGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) =>
                    MaintenanceRequestModel.fromJson(e as Map<String, dynamic>),
              )
              .toList();
        } else {
          throw Exception(
  ...
  Future<List<MaintenanceRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.externalMaintenanceGetActionItems,
          queryParameters: queryParams,
        );
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.externalMaintenanceSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.externalMaintenanceSendAttachmentById(id);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    ...
    final String url = status == 'rejected'
        ? ApiEndPoint.externalMaintenanceReject
        : ApiEndPoint.externalMaintenanceApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.externalMaintenanceChatsById(id);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.externalMaintenanceAttachmentsById(id);
        final response = await client.get(url);
  ...
  Future<void> deleteAttachment(int attachmentId) async {
    ...
    try {
      final response = await client.delete(
        ApiEndPoint.externalMaintenanceDeleteAttachment(attachmentId),
      );
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.externalMaintenanceRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<StationModel>> getStations() async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.externalMaintenanceStations;
      ...
      throw Exception('Error in getStations: $e');
    }
  }
}
