...
import 'package:code_setup/repository/maintenance/external_stations/data/data.dart';

abstract class ExternalMaintenanceRepository {
  factory ExternalMaintenanceRepository() =>
      ExternalMaintenanceRepositoryImpl();
