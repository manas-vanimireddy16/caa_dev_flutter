...
import 'package:code_setup/repository/security_access/import_export_permission/data/data.dart';

abstract class ImportExportPermissionRepository {
  factory ImportExportPermissionRepository() => ImportExportPermissionImpl();
