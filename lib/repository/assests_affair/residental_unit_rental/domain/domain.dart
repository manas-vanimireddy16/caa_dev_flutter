...
import 'package:code_setup/repository/assests_affair/residental_unit_rental/data/data.dart';
...
abstract class ResidentalUnitRentalRepository {
  factory ResidentalUnitRentalRepository() =>
      ResidentalUnitRentalRepositoryImple();
