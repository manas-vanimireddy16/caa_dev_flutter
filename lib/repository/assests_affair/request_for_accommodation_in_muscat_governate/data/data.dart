...
class RequestForAccommodationInMuscatGovernateRepositoryImple
    implements RequestForAccommodationInMuscatGovernateRepository {
  @override
  ...
  sendRequestForAccommodationInMuscatGovernateRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.sendRequestForAccommodationinMuscatGovernorate;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.accommodationinMuscatGovernorateKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.accommodationinMuscatGovernorateApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.accommodationinMuscatGovernorateApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.accommodationinMuscatGovernorateApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.accommodationinMuscatGovernorateStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.accommodationinMuscatGovernorateTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<AccommodationRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.accommodationinMuscatGovernorateGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => AccommodationRequestModel.fromJson(
  ...
  Future<List<AccommodationRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.accommodationinMuscatGovernorateGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => AccommodationRequestModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.accommodationinMuscatGovernorateSendChatById(
      id,
    );
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url =
        ApiEndPoint.accommodationinMuscatGovernorateSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.accommodationinMuscatGovernorateSendAttachmentById(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.accommodationinMuscatGovernorateApprove;
  ...
  Future<List<ChatMessageModel>> getchatById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.accommodationinMuscatGovernorateChatsById(id);
        final response = await client.get(url);
  ...
  Future<List<AttachmentModel>> getAttachmentsById(int id) async {
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.accommodationinMuscatGovernorateAttachmentById(
          id,
        );
        final response = await client.get(url);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.accommodationinMuscatGovernorateRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
