...
class VehicleMaintenanceRepositoryImpl implements VehicleMaintenanceRepository {
  static const String _serviceLabel = 'Vehicle Maintenance';
  @override
  ...
  @override
  Future<Map<String, dynamic>> vehicleMaintenanceCreateRequest(
    Map<String, dynamic> payload,
  ) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.vehicleMaintenanceSendRequest;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.vehicleMaintenanceKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.vehicleMaintenanceApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.vehicleMaintenanceApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.vehicleMaintenanceApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.vehicleMaintenanceStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.vehicleMaintenanceTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  @override
  Future<List<VehicleMaintenanceRequestModel>> getRequests({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.vehicleMaintenanceGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => VehicleMaintenanceRequestModel.fromJson(
  ...
  @override
  Future<List<VehicleMaintenanceRequestModel>> getActionItems({
    required int offset,
    required int limit,
    required int serviceId,
    required int subServiceId,
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.vehicleMaintenanceGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => VehicleMaintenanceRequestModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.vehicleMaintenanceSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.vehicleMaintenanceSendAttachmentById(id);
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.vehicleMaintenanceDeleteAttachment(attachmentId);
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.vehicleMaintenanceApprove;
  ...
  Future<List<ChatMessageModel>> getchatById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.vehicleMaintenanceChatsById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<AttachmentModel>> getAttachmentsById({
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.vehicleMaintenanceAttachmentsById(id);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.vehicleMaintenanceRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
