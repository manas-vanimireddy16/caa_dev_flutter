...
class RequestAVehicleRepositoryImpl implements RequestAVehicleRepository {
  static const String _serviceLabel = 'Request a Vehicle';
  // @override
  ...
  //     throw Exception(
  //       'Failed to fetch $_serviceLabel users: ${response.statusCode}',
  //     );
  //   } catch (e, st) {
  ...
  Future<Map<String, dynamic>> logisticsRequestVehicleCreateRequest(
    ...
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.logisticsRequestVehicleSendRequest;
  ...
  Future<KPIResponse?> getKpiData(int serviceId, int subServiceId) async {
    String url = ApiEndPoint.logisticsRequestVehicleKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<KPIResponse?> getApprovalKpiData({
    ...
    String url = ApiEndPoint.logisticsRequestVehicleApprovalKpiCards;
    final client = await KAppX.network.secureClient();
  ...
  Future<StatusBreakdownModel> getApprovalStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.logisticsRequestVehicleApprovalStatusBreakdown,
  ...
  Future<TrendBreakdownModel> getApprovalTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.logisticsRequestVehicleApprovalTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<StatusBreakdownModel> getStatusBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        queryParams.removeWhere((key, value) => value == null);
        final response = await client.get(
          ApiEndPoint.logisticsRequestVehicleStatusBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<TrendBreakdownModel> getTrendBreakdownData({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.logisticsRequestVehicleTrendBreakdown,
          queryParameters: queryParams,
        );
  ...
  Future<List<LogisticsVehicleRequestModel>> getRequests({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.logisticsRequestVehicleGetRequests;
        final response = await client.get(url, queryParameters: queryParams);
        ...
        if (response.statusCode == 200) {
          ...
          return list
              .map(
                (e) => LogisticsVehicleRequestModel.fromJson(
  ...
  Future<List<LogisticsVehicleRequestModel>> getActionItems({
    ...
    try {
      ...
      if (client != null) {
        ...
        final response = await client.get(
          ApiEndPoint.logisticsRequestVehicleGetActionItems,
          queryParameters: queryParams,
        );
        ...
        if (response.statusCode == 200 && response.data != null) {
          ...
          final actionItems = list
              .map(
                (item) => LogisticsVehicleRequestModel.fromJson(
  ...
  Future<String> sendChat(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.logisticsRequestVehicleSendChatById(id);
  ...
  Future<String> sendAttachment(Map<String, dynamic> payload, int id) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.logisticsRequestVehicleSendAttachmentById(
      id,
    );
  ...
  Future<void> deleteAttachment(int attachmentId, {int? requestId}) async {
    ...
    final url = ApiEndPoint.logisticsRequestVehicleDeleteAttachment(
      attachmentId,
    );
  ...
  Future<void> onApprove(Map<String, dynamic> payload) async {
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.logisticsRequestVehicleApprove;
  ...
  Future<List<ChatMessageModel>> getchatById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.logisticsRequestVehicleChatsById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<List<AttachmentModel>> getAttachmentsById({
    ...
    try {
      if (client != null) {
        final url = ApiEndPoint.logisticsRequestVehicleAttachmentsById(id);
  ...
  Future<RequestDetailData?> getRequestsById({
    ...
    try {
      if (client != null) {
        ...
        final url = ApiEndPoint.logisticsRequestVehicleRequestById(id);
        final response = await client.get(url, queryParameters: queryParams);
  ...
  Future<String> updateActualReturn(
    ...
    final client = await KAppX.network.secureClient();
    final String url = ApiEndPoint.logisticsRequestVehicleActualReturn(
      requestId,
    );
